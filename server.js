...
// than intended. EDIT THESE PRICES to whatever you decide after reviewing
// the shop. Amount is in plain PKR rupees (not paisas), matching what
// Safepay's checkout page displays (confirmed via sandbox testing).
const GEM_PACKS_SERVER = {
  g100:  { gems: 100,  amount: 300,  currency: 'PKR' }, // Rs. 300
  g550:  { gems: 550,  amount: 1500, currency: 'PKR' }, // Rs. 1,500
  g1200: { gems: 1200, amount: 3000, currency: 'PKR' }, // Rs. 3,000
  g2600: { gems: 2600, amount: 6000, currency: 'PKR' }  // Rs. 6,000
};
